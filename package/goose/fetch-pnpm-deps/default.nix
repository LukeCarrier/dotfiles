      ...
      (
        ...
        // {
          ...
          installPhase = ''
            ...
            # If the packageManager field in package.json specifies a different pnpm version,
            # pnpm would fail. Callers should set pmOnFail: ignore in pnpm-workspace.yaml.
