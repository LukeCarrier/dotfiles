        ...
        let
          ...
          overlays = [
            ...
            (
              ...
              in
              {
                inherit falcon-sensor-unwrapped cyberhaven-unwrapped;
                falcon-sensor = falcon-sensor.packages.${system}.falcon-sensor.override {
                  inherit falcon-sensor-unwrapped;
                };
                cyberhaven = cyberhaven.packages.${system}.cyberhaven.override {
                  inherit cyberhaven-unwrapped;
                };
              }
            )
          ];
